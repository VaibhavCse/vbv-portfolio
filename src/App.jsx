...
import sarveshart from "../public/projects/sarveshart.png";
...
export default function App() {
  ...
  const allProjects = [
    ...
    { id:5, title:"Sarvesh Art", category:"web", description:"Full-stack art e-commerce platform with payments, wishlist & customer assistant", fullDescription:"A full-stack e-commerce platform for selling original Indian oil paintings and prints. Built customer-facing shopping flows including product discovery, wishlist management, cart and checkout, payment gateway integration, email workflows, and responsive UI. Also implemented a rule-based Art Assistant to help visitors with common queries around artworks, pricing, commissions, shipping, and workshops.", tech:["React.js","Node.js","MongoDB","Payment Integration","Email Integration","Wishlist","E-commerce","Rule-based Chatbot"], image:sarveshart, demoLink:"https://sarveshdalviart.netlify.app/", featured:true, date:"2026" },

    { id:6, title:"PetExportVet", category:"wix", description:"Veterinary & pet export website (Wix)", fullDescription:"A marketing and informational website built on Wix for pet export and veterinary services. Designed with Wix's editor to provide clear service pages, contact flows, and basic SEO for lead generation.", tech:["Wix"], image:pet, demoLink:"https://www.petexportvet.com/", featured:false, date:"2025" },
